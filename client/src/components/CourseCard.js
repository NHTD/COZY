...
const CourseCard = ({image, courseName, price, startDay, courseLength}) => {
  return (
            ...
            <div className='pt-[20px] pb-[20px] pr-[25px] pl-[25px] bg-white rounded-md'>
                ...
                <div>
                    <ul className='text-[15px]'>
                        <li className='mx-[8px] my-[10px] flex'>
                            <span className='mr-[4px]'><MdOutlineCalendarToday/></span>
                            <span className='mr-[4px]'>Khai giảng: </span> <span className='text-[#6B7385] font-semibold'>{startDay}</span>
                        </li>
                        <li className='mx-[8px] my-[10px] flex'>
                            <span className='mr-[4px]'><MdOutlineCalendarToday/></span>
                            <span className='mr-[4px]'>Duration: </span> <span className='text-[#6B7385] font-semibold'>{courseLength}</span>
                        </li>
